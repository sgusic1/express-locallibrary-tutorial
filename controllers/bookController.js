...
exports.index = asyncHandler(async (req, res, next) => {
   //Get details of books, book instances, authors and genre counts (in parallel)
    const [numBooks, numBookInstances, numAvailableBookInstances, numAuthors, numGenres] = await
        Promise.all([
...
exports.book_delete_get = asyncHandler(async (req, res, next) => {
    ...
    const [ book, allBookInstances ] = await Promise.all([
        ...
        BookInstance.find({book: req.params.id }, "book status").populate({ path: "book", select: "title"}).exec(),
    ]);
...
exports.book_update_post = [
    ...
    asyncHandler(async (req, res, next) => {
       //Extract the validation errors from a request.
        ...
        //Create a Book with escaped/trimmed data and old id.
        const book = new Book({
            title: req.body.title,
            author: req.body.author,
            summary: req.body.summary,
