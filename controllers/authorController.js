...
exports.author_create_post = [
    ...
    body("first_name", ).trim().isLength({ min: 3 }).escape()
...
exports.author_update_post = [
     ...
     body("family_name", "Family name must not be empty.")
         ...
         .escape(),
     body("date_of_birth", "Invalid date of birth" ).optional({ values: "falsy" }).isISO8601().toDate(),
     body("date_of_death", "Invalid date of birth").optional({ values: "falsy" }).isISO8601().toDate(),
    ...
    asyncHandler(async (req, res, next) => {
        ...
        if (!errors.isEmpty()) {
            ...
            const updateAuthor = await Author.findByIdAndUpdate(author._id, author, {});
